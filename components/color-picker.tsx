...
export default function ColorPickerComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-blue-100 dark:bg-gray-700">
  ...
  <div
  className="w-48 h-48 rounded-full border-4 border-white-800 dark:border-gray-800 mx-auto"
